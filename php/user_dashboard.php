...
<body <?php if($_SESSION['theme'] == 'dark'){ echo "class='dark-theme'"; } ?>>
    <div class="navbar">
        ...
        <div class="menu">
            ...
            <a href=""><button class="secondary">Placeholder</button></a>
            <a href=""><button class="secondary">Placeholder</button></a>
            <a href=""><button class="secondary">Settings</button></a>
