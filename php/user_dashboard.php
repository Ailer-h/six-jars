...
<body <?php if($_SESSION['theme'] == 'dark'){ echo "class='dark-theme'"; } ?>>
    <div class="navbar">
        ...
        <div class="menu">
            ...
            <a href="settings.php"><button class="secondary">Settings</button></a>
